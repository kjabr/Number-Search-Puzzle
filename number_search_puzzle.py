...
for n in range (17):
    ...
    html_content += """<DIV style="position: absolute; font-family: arial; font-style: italic;
        font-variant:small-caps; font-weight:bold;letter-spacing: 4px; font-size:25;
        top: """ + str(position_from_top) + """px; width: 550px; left: 40px; height: 25px">"""
...
position_from_top = 40  # need to reinit the position from top for the numbers
...
# at the end
    ...
    html_content += """<DIV style="position: absolute; font-family: arial; font-style: italic;
        font-variant:small-caps; font-weight:bold;letter-spacing: 4px; font-size:25;
        top: """ + str(position_from_top) + """px; width: 250px; left: 650px; height: 25px">"""
